...
spark = SparkSession \
    .builder \
    .appName("s3_job") \
    .config("spark.jars", "apps/aws-java-sdk-bundle-1.11.874.jar") \
    .config("spark.jars", "apps/hadoop-aws-3.2.0.jar") \
    .getOrCreate()
...
try:
    shutil.rmtree("data/wc/result/1")
except:
    print()
result.saveAsTextFile("data/wc/result/1")
